...
const Skills = () => {
  return (
    <div className="skill-area pt-3 pb-3" id="skills">
      <div className="container">
      <h1 className="skill-title text-center">TECH <span style={{color:'#ff1818'}}>SKILLS</span> </h1>
      <CardDeck>
              ...
              <Card.Body>
                ...
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  {skills.frontend.map((skill, index) => (
                    <span className="text-center p-2" key={index}>
